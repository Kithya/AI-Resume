  ...
  return (
    <div className="max-w-5xl w-full mx-auto p-10 text-gray-800">
      ...
      <div className="grid md:grid-cols-3 mt-16">
        <div>
          <svg
            className="text-green-500 bg-green-500/20 p-2.5 aspect-square rounded-full size-10"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <div>
          ...
          <p className="text-lg font-bold mt-2">Visit My GitHub</p>
          <p className="text-gray-500 mt-1 mb-4">
            Visit my github for my projects
          </p>
          <a
            href="https://github.com/Kithya"
            className="text-green-600 font-semibold"
          >
            Github.com
          </a>
